...
{    
    ...
    public VirtualJoystick camera_Joystick;
    ...
    void Start()
    {
        ...
        transform.position = GameManager.instance.nextPlayerPosition;//指定された位置からStart
        ...
        switch (PlayerState)
        {
            case (MovementState.Move):
                ...
                if (knockBackCounter <= 0)
                {
                    ...
                    if (controller.isGrounded)//Mapに触れた時
                    {
    ...
    public void SettingUI(bool p_flag)
    {
        ...
        camera_Joystick.inputVector = Vector3.zero;
        camera_Joystick.joystickImg.rectTransform.anchoredPosition = Vector3.zero;
    }
